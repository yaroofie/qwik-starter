    ...
    <>
      <div class='pb-10'>
        ...
        <div class='py-5'>
          ...
          <a class='fw-bolder me-1' href={`${REACT_APP_BOOTSTRAP_DOCS_LINK}/content/tables/`}>
            Bootstrap Tables
          </a>
      ...
      <div class='py-10'>
        ...
        <div class='py-5'>
          ...
          <a href={`${REACT_APP_BOOTSTRAP_DOCS_LINK}/layout/gutters/`} class='fw-bolder me-1'>
            Bootstrap Gutters
          </a>
          classes
          <code>.g-*</code>&nbsp;,
      ...
      <div class='py-10'>
        <h1 class='anchor fw-bolder mb-5' id='striped-rows'>
      ...
      <div class='py-10'>
        <h1 class='anchor fw-bolder mb-5' id='hoverable-rows'>
      ...
      <div class='py-10'>
        <h1 class='anchor fw-bolder mb-5' id='active-rows'>
      ...
      <div class='py-10'>
        <h1 class='anchor fw-bolder mb-5' id='responsive-table'>
        ...
        <div class='py-5'>
          ...
          <a href={`${REACT_APP_BOOTSTRAP_DOCS_LINK}/content/tables/`} class='fw-bolder me-1'>
            Bootstrap Tables
          </a>
          documentation.
        </div>
...
const code = `<table class="table table-row-dashed table-row-gray-300 gy-7">
  <thead>
      <tr class="fw-bolder fs-6 text-gray-800">
          <th>Name</th>
          <th>Position</th>
...
const code2 = `<table class="table gs-7 gy-7 gx-7">
  <thead>
      <tr class="fw-bold fs-6 text-gray-800 border-bottom border-gray-200">
          <th>Name</th>
          <th>Position</th>
...
const code4 = `<table class="table table-striped gy-7 gs-7">
  <thead>
      <tr class="fw-bold fs-6 text-gray-800 border-bottom border-gray-200">
          <th>Name</th>
          <th>Position</th>
...
const code5 = `<table class="table table-rounded table-striped border gy-7 gs-7">
  <thead>
      <tr class="fw-bold fs-6 text-gray-800 border-bottom border-gray-200">
          <th>Name</th>
          <th>Position</th>
...
const code6 = `<table class="table table-rounded table-flush">
  <thead>
      <tr class="fw-bold fs-7 text-danger border-bottom border-gray-200 py-4">
          <th>Name</th>
          <th>Position</th>
...
const code7 = `<table class="table table-hover table-rounded table-striped border gy-7 gs-7">
  <thead>
      <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
          <th>Name</th>
          <th>Position</th>
...
const code8 = `<table class="table table-rounded table-row-bordered border gy-7 gs-7">
  <thead>
      <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
          <th>Name</th>
          <th>Position</th>
...
const code9 = `<table class="table table-striped table-rounded border border-gray-300 table-row-bordered table-row-gray-300 gy-7 gs-7">
  <thead>
      <tr class="fw-bold fs-4 text-gray-800">
          <th scope="col">#</th>
          <th scope="col">First</th>
...
const code10 = `<div class="table-responsive">
  <table class="table table-striped gy-7 gs-7">
      <thead>
          <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
              <th class="min-w-200px">Name</th>
